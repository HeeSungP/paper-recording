...
class myUnet(object):
    def __init__(self, img_rows=512, img_cols=512, custom_name='/hs_v4_2'):
    ...
    def get_unet(self):
        ...
        model.compile(optimizer=Adam(lr=1e-4), loss='binary_crossentropy', metrics=['accuracy','mse']) # categorical_crossentropy binary_crossentropy
