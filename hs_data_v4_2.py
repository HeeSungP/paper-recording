...
class dataProcess(object):
    def __init__(self, out_rows, out_cols, train_path="PPtest/train_first", train_label="PPtest/trainannot",
                 guide_path = 'PPtest/guide', custom_name = "/hs_v4_2", # / 앞에 붙어야하고 뒤에 _ 붙음
                 test_path="PPtest/test_first", test_label='PPtest/testannot', npy_path="./npydata", img_type="jpg"):
