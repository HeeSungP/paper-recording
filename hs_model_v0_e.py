...
class myUnet(object):
    def __init__(self, img_rows=512, img_cols=512, custom_name='/hs_v0_e'):
    ...
    def get_unet(self):
        ...
        conv1 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer='he_normal')(guides)
        ...
        # conv10 = Conv2D(2, 3, activation='relu', padding='same', kernel_initializer='he_normal')(concatenate10)
    ...
    def train(self):
        ...
        print('Fitting model...')
        model.fit((imgs_train, imgs_guide_train), imgs_mask_train, batch_size=4, epochs=50, verbose=1,
